...
Page({
  ...
  onAdvMiaosha: function() {
    // var url = this.data.index_adv.adv_miaoshaurl;
    var url = '/pages/vip/index'
  ...
  onAdvLeft: function() {
    //var url = this.data.index_adv.adv_box_lefturl;
    var url = '/pages/vip/index?loadtype=fine';
    if (url != '')
      wx.navigateTo({
        url: url,
      });
  ...
  onAdvRight: function() {
    var url = this.data.index_adv.adv_box_righturl;
    if (url != '')
      wx.navigateTo({
        url: url,
      });
  ...
  _info_set: function() {
    ...
    a.util.request({
      ...
      success: function(a) {
        ...
        t.setData({
          index_adv: {
            adv_miaosha: a.data.data.ad_three,
            adv_miaoshaurl: a.data.data.ad_threeurl,
            adv_box_left: a.data.data.ad_one,
            adv_box_lefturl: a.data.data.ad_oneurl,
            adv_box_right: a.data.data.ad_two,
            adv_box_righturl: a.data.data.ad_twourl,
          }
        }), wx.setStorageSync('siteinfo', a.data.data);
      }
    });
  },
  _notice: function() {
    ...
    a.util.request({
      ...
      success: function(a) {
        console.log(a), a.data.data.info_name.name && wx.setNavigationBarTitle({
          ...
          tj_car: a.data.data.tj_car
        });
        console.log(t.data.brand);
      }
    });
  },
  ok: function() {
  ...
  market_brand: function(t) {
    wx.navigateTo({
      url: "../selectscards/index?type=search"
    });
  },
  car_detail: function(t) {
    var e = !1,
      i = a.getAttr(t, "active_index");
